package com.paqta.paqtafood.screens.staffFragment.components;
...
public class FormStaffFragment extends Fragment {
    ...
    TextInputEditText edtTxtUsername, edtTxtRol, edtTxtPassword;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtTxtRol = root.findViewById(R.id.edtTextRol);
        ...
        if (idStaff == null || idStaff.isEmpty()) {
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String rol = edtTxtRol.getText().toString().trim();
                    String password = edtTxtPassword.getText().toString().trim();

                    if (validar(username, rol, password)) {
                        postStaff(username, rol, password);
                    }
                }
            });
        } else {
            ...
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (validar(username, rol, password)) {
                        updateStaff(username, rol, password);
                    }
                }
            });
        }
    ...
    private void updateStaff(String username, String rol, String password) {
    ...
    private void postStaff(String username, String rol, String password) {

        DocumentReference documentReference = mFirestore.collection("usuarios").document();
    ...
    private boolean validar(String username, String rol, String password) {
        ...
        if (username.isEmpty() || rol.isEmpty() || password.isEmpty()) {
