package com.paqta.paqtafood.screens.staff.components;
...
public class FormStaffFragment extends Fragment {
    ...
    TextInputEditText edtTxtName, edtTxtUsername, edtTxtRol, edtTxtPassword, edtTxtEmail, edtTxtAddress, edtTxtPhone, edtTxtDNI;
...
//        edtTxtName = root.findViewById(R.id.edtTextNames);
        edtTxtUsername = root.findViewById(R.id.edtTextUsername);
        edtTxtEmail = root.findViewById(R.id.edtTextEmail);
//        edtTxtAddress = root.findViewById(R.id.edtTextDireccion);
//        edtTxtPhone = root.findViewById(R.id.edtTextPhone);
//        edtTxtDNI = root.findViewById(R.id.edtTextDNI);
...
//                    String nombres = edtTxtName.getText().toString();
...
//                    String dni = edtTxtDNI.getText().toString();
