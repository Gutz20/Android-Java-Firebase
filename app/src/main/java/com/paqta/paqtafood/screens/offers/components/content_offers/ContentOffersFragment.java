package com.paqta.paqtafood.screens.offers.components.content_offers;
...
public class ContentOffersFragment extends Fragment {
    ...
    public ContentOffersFragment() {
    }

    public static ContentOffersFragment newInstance(String param1, String param2) {
