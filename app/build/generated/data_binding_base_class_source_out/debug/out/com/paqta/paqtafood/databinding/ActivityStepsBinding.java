...
public final class ActivityStepsBinding implements ViewBinding {
  ...
  private ActivityStepsBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView descriptionTextView, @NonNull TextView stepTextView,
  ...
  public static ActivityStepsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStepsBinding((ConstraintLayout) rootView, descriptionTextView,
