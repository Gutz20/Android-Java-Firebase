...
public final class FragmentFormProductBinding implements ViewBinding {
  ...
  private FragmentFormProductBinding(@NonNull FrameLayout rootView, @NonNull Button btnAdd,
  ...
  public static FragmentFormProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFormProductBinding((FrameLayout) rootView, btnAdd, btnDeleteImage,
