...
public final class ActivityDishesBinding implements ViewBinding {
  ...
  private ActivityDishesBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      ...
      @NonNull ImageView imageView38, @NonNull MaterialDivider materialDivider1,
      @NonNull MaterialDivider materialDivider2, @NonNull MaterialDivider materialDivider3,
      @NonNull MaterialDivider materialDivider4, @NonNull MaterialDivider materialDivider5,
      ...
      @NonNull TextView textView27, @NonNull TextView textView29, @NonNull TextView textView30,
      @NonNull TextView textView4, @NonNull TextView title) {
  ...
  @NonNull
  public static ActivityDishesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDishesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_dishes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDishesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDishesBinding((ConstraintLayout) rootView, button, imageView24,
          imageView25, imageView26, imageView28, imageView29, imageView30, imageView31, imageView32,
          imageView33, imageView35, imageView36, imageView37, imageView38, materialDivider1,
          materialDivider2, materialDivider3, materialDivider4, materialDivider5, textView20,
          textView22, textView23, textView24, textView25, textView26, textView27, textView29,
          textView30, textView4, title);
    }
